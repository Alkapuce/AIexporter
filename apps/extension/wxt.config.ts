...
const workspaceAlias = {
  ...
  "@aiexporter/adapters-chatgpt": fileURLToPath(new URL("../../packages/adapters-chatgpt/src/index.ts", import.meta.url)),
  "@aiexporter/adapters-deepseek": fileURLToPath(new URL("../../packages/adapters-deepseek/src/index.ts", import.meta.url)),
...
export default defineConfig({
  ...
  manifest: {
    name: "AIexporter",
    description: "Auto-export ChatGPT, Gemini, AI Studio, and DeepSeek conversations to Markdown and archive them locally.",
    permissions: ["storage", "downloads", "downloads.ui", "downloads.open", "tabs", "scripting", "alarms", "nativeMessaging"],
    host_permissions: [
      "https://chatgpt.com/*",
